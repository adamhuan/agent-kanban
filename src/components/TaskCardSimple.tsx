...
export default function TaskCardSimple({ task }: TaskCardProps) {
  return (
    <div className="bg-white rounded-lg shadow-sm border p-4 mb-3 hover:shadow-md transition-shadow duration-200">
